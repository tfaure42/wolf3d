...
/*   Updated: 2017/08/30 14:48:31 by ocojeda-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_forward(t_env *env)
{
	...
	tmpx = env->dat->px + 0.1 * cos(env->dat->alpha * M_PI / 180);
	tmpy = env->dat->py + 0.1 * sin(env->dat->alpha * M_PI / 180) * -1;
...
void	move_left(t_env *env)
{
	...
	tmpy = env->dat->py + 0.1 * cos(env->dat->alpha * M_PI / 180) * -1;
	tmpx = env->dat->px + (0.1 * sin(env->dat->alpha * M_PI / 180)) * -1;
	if (env->dat->map[fl_to_int(tmpx)][fl_to_int(tmpy)] != '1'
		&& (tmpx) >= 0.5 && (tmpy) >= 0.5 && (tmpx)
			<= env->dat->map_size - 1.5 && (tmpy) <= env->dat->map_size - 1.5)
	{
